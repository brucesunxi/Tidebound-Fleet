...
主界面参考已核查录屏：中央大角色换成本作旗舰、主要按钮在底部、角色可低幅活动，按钮和文字保持稳定；不复制竞品角色与品牌。结算保留下一关主操作与可获取奖励的进度，取消海域完成统计。第2关领取蓝皮先回主界面，再显式装备／开始第3关；第10关显示当前内容完成。每日奖励、邀请有礼、排行榜按A3在主页预留，业务实现后置；不加入假排名或付费促销。
