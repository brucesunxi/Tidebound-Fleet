...
**V2-C2最小接入（2026-09-21）：** 港湾／六图标、公共圆角UI、四分类收藏壳、独立抽奖页、滚动补给和单语言设置已接Unity；原钱包／抽奖／保底／五槽服务复用。程序展示船与卡面仍非终版美术，三类通关外观只显示待配置状态；D1／D2继续解锁存档与奖励目标／分享。中文字体随工程打包，Android网络国家码适配尚待真机，iOS／未知地区回退英文，手选优先。验证与边界见[C2记录](验证记录/V2C2_UI与语言/C2_VALIDATION.md)。
