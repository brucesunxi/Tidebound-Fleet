...
namespace SupersonicWisdomSDK.Editor
{
    internal class SwAndroidManifest : SwAndroidXmlDocument
    {
        ...
        {
            element.SetAttribute(name, ANDROID_XML_NAMESPACE, value);
        }
        ...
        internal void SetMetadataElement(string name, string value)
        {
            ...
            metaData.SetAttribute("name", ANDROID_XML_NAMESPACE, name);
            metaData.SetAttribute("value", ANDROID_XML_NAMESPACE, value);
            SetOrReplaceXmlElement(_applicationElement, metaData);
        }

        private XmlAttribute CreateAndroidAttribute(string key, string value)
        {
            var attr = CreateAttribute("android", key, ANDROID_XML_NAMESPACE);
            attr.Value = value;
