...
namespace SupersonicWisdomSDK.Editor
{
    internal class SwAndroidXmlDocument : XmlDocument
    {
        ...
        private const string SCHEME_NAMESPACE_URL = "http://schemas.android.com/";
        public const string ANDROID_XML_NAMESPACE = SCHEME_NAMESPACE_URL + "apk/res/android";
        public const string TOOLS_XML_NAMESPACE = SCHEME_NAMESPACE_URL + "tools";
        ...
        public SwAndroidXmlDocument(string path)
        {
            ...
            nsMgr.AddNamespace("android", ANDROID_XML_NAMESPACE);
        }
