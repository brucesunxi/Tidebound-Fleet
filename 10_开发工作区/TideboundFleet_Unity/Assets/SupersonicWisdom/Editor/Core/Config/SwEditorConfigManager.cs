    ...
    internal static class SwEditorConfigManager
    {
        ...
        private static async Task FetchConfig()
        {
            ...
            try
            {
                ...
                {
                    configData = SwUtils.JsonHandler.DeserializeObject<SwEditorConfigData>(jsonString ?? SwEditorConstants.EMPTY_STRINGIFIED_JSON);
                }
            }
            catch (Exception e)
            {
            ...
            await File.WriteAllTextAsync(ConfigFilePath, SwUtils.JsonHandler.SerializeObject(_currentConfigData));
        ...
        private static async Task LoadConfigFromFile()
        {
            if (File.Exists(ConfigFilePath))
            {
                try
                {
                    ...
                    {
                        _currentConfigData = SwUtils.JsonHandler.DeserializeObject<SwEditorConfigData>(jsonString);
                    }
                }
                catch (Exception e)
                {
