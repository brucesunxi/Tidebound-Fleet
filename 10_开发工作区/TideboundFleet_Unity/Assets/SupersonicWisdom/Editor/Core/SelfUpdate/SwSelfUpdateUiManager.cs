...
namespace SupersonicWisdomSDK.Editor
{
    internal static class SwSelfUpdateUiManager
    {
        ...
        internal static void ShowUpdateConfirmation()
        {
            ...
            stageUpdateConfiguration = new SwJsonDictionary(SwUtils.JsonHandler.DeserializeObject<Dictionary<string, object>>(stageUpdateConfiguration.SwSafelyGet(stageKey, null)?.ToString() ?? string.Empty));
