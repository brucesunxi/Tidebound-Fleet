...
namespace SupersonicWisdomSDK.Editor
{
    internal static class SwSelfUpdatePackageDownloader
    {
        ...
        internal static async Task<(string, int, string)> DownloadUpdatePackageWithCheckSum(string remoteUrl, string localDestinationFilePath)
        {
            ...
            {
                SwEditorTracker.TrackEditorEvent(nameof(DownloadUpdatePackageWithCheckSum), ESwEditorWisdomLogType.SelfUpdate, ESwEventSeverity.Error, exception.ToString());
                SwSelfUpdateUiManager.Alert(SwEditorConstants.UI.FAILED_TO_DOWNLOAD_UNITY_PACKAGE, SwEditorConstants.UI.ButtonTitle.CLOSE, SwErrors.ESelfUpdate.InternalError);
            }
